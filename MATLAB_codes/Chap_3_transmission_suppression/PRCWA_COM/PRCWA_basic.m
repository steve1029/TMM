...
ni=1.46+j*1e-5;                       %  refractive index in region I
epri=ni^2;                  % permittivity in region I
muri=1;                     % permeability in region I

nf=1.46+j*1e-5;       				% refractive index in region II
...
% for 3D structure
nx=50;              % x direction truncation order
% nx=10;              % x direction truncation order
