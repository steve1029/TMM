...
% xx=1*[-Tx_set(end)/1*nm:Tx*0.002:Tx_set(end)/1*nm]';
xx=[-1000*nm:10*nm:1000*nm]';
z_start=-2*lambda;
z_end=Height+2*lambda;
z_inc=10*nano;
...
%         Ey_xz3=Ey_xz3+Uy*exp(j*( kx0*x3+ky0*y-kz0*(z3-ac_thick(Nlay))));
%         Ex_xz3=Ex_xz3+Ux*exp(j*( kx0*x3+ky0*y-kz0*(z3-ac_thick(Nlay))));
%         Ez_xz3=Ez_xz3+Uz*exp(j*( kx0*x3+ky0*y-kz0*(z3-ac_thick(Nlay))));
%         Hy_xz3=Hy_xz3+Vy*exp(j*( kx0*x3+ky0*y-kz0*(z3-ac_thick(Nlay))));
%         Hx_xz3=Hx_xz3+Vx*exp(j*( kx0*x3+ky0*y-kz0*(z3-ac_thick(Nlay))));
%         Hz_xz3=Hz_xz3+Vz*exp(j*( kx0*x3+ky0*y-kz0*(z3-ac_thick(Nlay))));
...
% figure(1); imagesc(zz/um,xx/um,real(Ex_xz)); set(gca,'fontsize',16); colorbar; title('Ex-xz'); xlabel('z-axis (\mum)');ylabel('x-axis (\mum)'); set(gca,'fontsize',16);print(sprintf('data/Ex_%04d.jpg',Tx_set(Tx_idx)),'-djpeg');
% figure(2); imagesc(zz/um,xx/um,real(Ey_xz)); set(gca,'fontsize',16); colorbar; title('Ey-xz'); xlabel('z-axis (\mum)');ylabel('x-axis (\mum)'); set(gca,'fontsize',16);print(sprintf('data/Ey_%04d.jpg',Tx_set(Tx_idx)),'-djpeg');
% figure(3); imagesc(zz/um,xx/um,real(Ez_xz)); set(gca,'fontsize',16); colorbar; title('Ez-xz'); xlabel('z-axis (\mum)');ylabel('x-axis (\mum)'); set(gca,'fontsize',16);print(sprintf('data/Ez_%04d.jpg',Tx_set(Tx_idx)),'-djpeg');
% 
% 
% figure(4); imagesc(zz/um,xx/um,real(Hx_xz)); set(gca,'fontsize',16); colorbar; title('Hx-xz'); xlabel('z-axis (\mum)');ylabel('x-axis (\mum)');  set(gca,'fontsize',16);print(sprintf('data/Hx_%04d.jpg',Tx_set(Tx_idx)),'-djpeg');
% figure(5); imagesc(zz/um,xx/um,real(Hy_xz)); set(gca,'fontsize',16); colorbar; title('Hy-xz'); xlabel('z-axis (\mum)');ylabel('x-axis (\mum)');  set(gca,'fontsize',16);print(sprintf('data/Hy_%04d.jpg',Tx_set(Tx_idx)),'-djpeg');
% figure(6); imagesc(zz/um,xx/um,real(Hz_xz)); set(gca,'fontsize',16); colorbar; title('Hz-xz'); xlabel('z-axis (\mum)');ylabel('x-axis (\mum)');  set(gca,'fontsize',16);print(sprintf('data/Hz_%04d.jpg',Tx_set(Tx_idx)),'-djpeg');


figure(61);set(gca,'fontsize',16);set(gca,'fontname','times new roman');
imagesc(zz/um,xx/um,real(Hy_xz)); set(gca,'ydir','normal');
axis([zz(1)/um zz(end)/um xx(1)/um xx(end)/um]);set(gca,'fontsize',16);set(gca,'fontname','times new roman');
colorbar; set(gca,'fontsize',16);set(gca,'fontname','times new roman');
title('Hy-xz'); xlabel('z-axis (\mum)');ylabel('x-axis (\mum)');  set(gca,'fontsize',16);set(gca,'fontname','times new roman');
set(gca,'fontsize',16);
