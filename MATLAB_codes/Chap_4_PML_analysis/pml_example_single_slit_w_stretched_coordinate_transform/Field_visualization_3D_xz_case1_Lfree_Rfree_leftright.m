...
%%
% figure(32);set(gca,'fontname','times new roman');
% 
% imagesc(zz/um,xx/um,1/max(max(abs(Hy_xz2)))*real(Hy_xz2)); set(gca,'ydir','normal');set(gca,'fontsize',16); colorbar; title('Hy-xz'); set(gca,'fontname','times new roman');xlabel('z-axis (\mum)');ylabel('x-axis (\mum)'); set(gca,'fontsize',16);set(gca,'fontname','times new roman');caxis([-0.2 0.2]);


figure(32); imagesc(zz/um,xx/um,1/max(max(abs(Hy_xz2)))*real(Hy_xz2));
set(gca,'ydir','normal');
...
caxis([-0.17 0.17]);set(gca,'fontsize',16);set(gca,'fontname','times new roman');
