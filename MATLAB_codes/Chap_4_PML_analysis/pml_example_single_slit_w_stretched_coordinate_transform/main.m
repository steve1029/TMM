...
ni=1.0;                 % refractive index in region I
nf=1;                   % refractive index in region II
Tx=6.000001*micro;		% x-size of the computation cell
Ty=Tx;                  % y-size of the computation cell
nx=200;                 % x direction truncation order
...
% new pml
if ny==0
    PRCWA_Gen_PML1D_stretched;                            %   PML build
else
    PRCWA_Gen_PML2D_stretched;                            %   PML build
end
