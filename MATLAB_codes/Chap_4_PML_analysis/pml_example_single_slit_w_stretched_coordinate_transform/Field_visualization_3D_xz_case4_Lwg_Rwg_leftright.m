...
% positive eigenmode
% Einc(p_ind2(1))=1;
Einc(800)=1; % this was found by experience..
...
imagesc(zz/um,xx/um,real(Hy_xz));set(gca,'fontname','times new roman');set(gca,'ydir','normal');
xlabel('z-axis (\mum)');set(gca,'fontname','times new roman');
ylabel('x-axis (\mum)');set(gca,'fontname','times new roman');
colorbar;caxis([-5e-5 5e-5]);set(gca,'fontsize',16);set(gca,'fontname','times new roman');
return
...
while 1
    ...
    imagesc(zz/um,xx/um,real(exp(-j*tt)*Hy_xz));set(gca,'fontname','times new roman');set(gca,'ydir','normal');
    xlabel('z-axis (\mum)');set(gca,'fontname','times new roman');
    ylabel('x-axis (\mum)');set(gca,'fontname','times new roman');
    colorbar;caxis([-5e-5 5e-5]);set(gca,'fontsize',16);set(gca,'fontname','times new roman');
    pause(0.1);
