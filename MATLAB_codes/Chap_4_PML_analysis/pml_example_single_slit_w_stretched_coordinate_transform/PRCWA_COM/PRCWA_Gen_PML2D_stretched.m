...
pml_y=(Ty/2-pml_width) + pml_width*([pml_num pml_N+1]-1)/pml_N;
...
%     disp([num2str(mm) ' / ' num2str(num_hx)]);
    ...
    for nn=1:num_hy
        ...
        % region 0
        rect_region0(mm,nn)=rect_2D(m,n,1,Tx,Ty,-e_x/2,e_x/2,-e_y/2,e_y/2);
        ...
        for k=1:pml_N-2
            ...
            cos2sy=1;
            rect_form=rect_2D(m,n,1,Tx,Ty, pml_x1, pml_x2,-e_y/2,e_y/2);
            PML_stretched_evaluate;
            rect_form=rect_2D(m,n,1,Tx,Ty,-pml_x2,-pml_x1,-e_y/2,e_y/2);
            PML_stretched_evaluate;
            ...
            pml_y2=pml_y(k+1);
            cos2sx=1;
            cos2sy=(1-gam)*cos(pi * (abs(pml_y1)-e_y/2) / q_y)^2/sy;
            rect_form=rect_2D(m,n,1,Tx,Ty,-e_x/2,e_x/2, pml_y1, pml_y2);
            PML_stretched_evaluate;
            rect_form=rect_2D(m,n,1,Tx,Ty,-e_x/2,e_x/2,-pml_y2,-pml_y1);
            PML_stretched_evaluate;
            ...
            for l=1:pml_N-2
                ...
                % region 5 and 6
                rect_form=rect_2D(m,n,1,Tx,Ty, pml_x1, pml_x2, pml_y1, pml_y2);
                PML_stretched_evaluate;
                rect_form=rect_2D(m,n,1,Tx,Ty,-pml_x2,-pml_x1,-pml_y2,-pml_y1);
                PML_stretched_evaluate;

                % region 7 and 8
                rect_form=rect_2D(m,n,1,Tx,Ty, pml_x1, pml_x2,-pml_y2,-pml_y1);
                PML_stretched_evaluate;
                rect_form=rect_2D(m,n,1,Tx,Ty,-pml_x2,-pml_x1, pml_y1, pml_y2);
                PML_stretched_evaluate;
            end
        end
    end
