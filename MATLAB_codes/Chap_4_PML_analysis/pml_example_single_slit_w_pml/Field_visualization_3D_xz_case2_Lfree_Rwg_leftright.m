...
% xx=linspace(-7.5*um,7.5*um,301)';
xx=2*[-Tx/2:Tx*0.002:Tx/2]';
%xx=5*[-Tx/2:Tx*0.002:Tx/2]';
z_start=-0*um;%z_start=-10*um;
z_end=20*um;
z_inc=50*nano;
...
% save('field_dist.mat','Ex_xz','Ey_xz','Ez_xz','Hx_xz','Hy_xz','Hz_xz','Intensity','zz','um');
% load('field_dist.mat');
% save('field_dist_wo_grating_w_pml.mat','Ex_xz','Ey_xz','Ez_xz','Hx_xz','Hy_xz','Hz_xz','Intensity','zz','um');
% load('field_dist_wo_grating_w_pml.mat');


% Intensity=Ex_xz.*conj(Ex_xz)+Ey_xz.*conj(Ey_xz)+Ez_xz.*conj(Ez_xz);
% figure(1); imagesc(zz(10:end)/um,xx/um,1/max(max(Intensity(:,10:end)))*Intensity(:,10:end));
% set(gca,'ydir','normal');
% set(gca,'fontsize',16); set(gca,'fontname','times new roman');colorbar; title('Ex-xz'); set(gca,'fontname','times new roman');xlabel('z-axis (\mum)');set(gca,'fontname','times new roman');ylabel('x-axis (\mum)');set(gca,'fontname','times new roman');
% caxis([0 0.3]);colormap(hot); set(gca,'fontsize',16);set(gca,'fontname','times new roman');

figure(22); imagesc(zz(10:end)/um,xx/um,1/max(max(abs(Hy_xz(:,10:end))))*real(Hy_xz(:,10:end)));
set(gca,'ydir','normal');
set(gca,'fontsize',16); set(gca,'fontname','times new roman');colorbar; title('Hy-xz'); set(gca,'fontname','times new roman');xlabel('z-axis (\mum)');set(gca,'fontname','times new roman');ylabel('x-axis (\mum)');set(gca,'fontname','times new roman');
caxis([-0.3 0.3]);set(gca,'fontsize',16);set(gca,'fontname','times new roman');

% figure(1); imagesc(zz/um,xx/um,abs(Ex_xz)); set(gca,'fontsize',16); colorbar; title('Ex-xz'); xlabel('z-axis (\mum)');ylabel('x-axis (\mum)');colormap(hot); set(gca,'fontsize',16);
% figure(2); imagesc(zz/um,xx/um,real(Ey_xz)); set(gca,'fontsize',16); colorbar; title('Ey-xz'); xlabel('z-axis (\mum)');ylabel('x-axis (\mum)');colormap(hot); set(gca,'fontsize',16);
% figure(3); imagesc(zz/um,xx/um,real(Ez_xz)); set(gca,'fontsize',16); colorbar; title('Ez-xz'); xlabel('z-axis (\mum)');ylabel('x-axis (\mum)');colormap(hot); set(gca,'fontsize',16);
% 
% 
% figure(4); imagesc(zz/um,xx/um,real(Hx_xz)); set(gca,'fontsize',16); colorbar; title('Hx-xz'); xlabel('z-axis (\mum)');ylabel('x-axis (\mum)'); colormap(hot); set(gca,'fontsize',16);
% figure(5); imagesc(zz/um,xx/um,real(Hy_xz)); set(gca,'fontsize',16); colorbar; title('Hy-xz'); xlabel('z-axis (\mum)');ylabel('x-axis (\mum)'); colormap(hot); set(gca,'fontsize',16);
% figure(6); imagesc(zz/um,xx/um,real(Hz_xz)); set(gca,'fontsize',16); colorbar; title('Hz-xz'); xlabel('z-axis (\mum)');ylabel('x-axis (\mum)'); colormap(hot); set(gca,'fontsize',16);
