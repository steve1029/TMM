...
xx=linspace(-7.5*um,7.5*um,301)';%xx=1*[-Tx/2:Tx*0.002:Tx/2]';%xx=5*[-Tx/2:Tx*0.002:Tx/2]';
...
set(gca,'ydir','normal');
set(gca,'fontsize',16); set(gca,'fontname','times new roman');colorbar; title('Ex-xz'); set(gca,'fontname','times new roman');xlabel('z-axis(um)');set(gca,'fontname','times new roman');ylabel('x-axis(um)');set(gca,'fontname','times new roman');
caxis([0 0.3]);colormap(hot); set(gca,'fontsize',16);set(gca,'fontname','times new roman');
% figure(1); imagesc(zz/um,xx/um,abs(Ex_xz)); set(gca,'fontsize',16); colorbar; title('Ex-xz'); xlabel('z-axis(um)');ylabel('x-axis(um)');colormap(hot); set(gca,'fontsize',16);
