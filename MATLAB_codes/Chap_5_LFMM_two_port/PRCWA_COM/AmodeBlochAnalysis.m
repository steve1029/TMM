...
%% STEP2.1 S-matrix & coupling coefficeint operator of super-block
%comprising the unit super-block structure
...
%% STEP2.2 Algebraic Maxwell eigenvalue equation for Bloch eigenmode 
...
%% STEP2.3 pseudo-Fourier representation of Bloch eigenmodes        
%         
% nz=nx;
% NBz=2*nz+1;
% num_hz=2*NBz-1; 
