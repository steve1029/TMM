%% Field visualization case 0 right-left
...
[z1 x1]=meshgrid(zz(zz1ind(1):zz1ind(2)),xx); % region 1
  for k=1:NBx
           for l=1:NBy
           Ey_xz1=Ey_xz1+ET1y_cof(k,l)*exp(j*( kx_vc(k)*x1+ky_vc(l)*y-kz_vc(k,l)*z1 ));   
           Ex_xz1=Ex_xz1+ET1x_cof(k,l)*exp(j*( kx_vc(k)*x1+ky_vc(l)*y-kz_vc(k,l)*z1 ));
           Ez_xz1=Ez_xz1+ET1z_cof(k,l)*exp(j*( kx_vc(k)*x1+ky_vc(l)*y-kz_vc(k,l)*z1 ));
           
           Hy_xz1=Hy_xz1+HT1y_cof(k,l)*exp(j*( kx_vc(k)*x1+ky_vc(l)*y-kz_vc(k,l)*z1 ));   
           Hx_xz1=Hx_xz1+HT1x_cof(k,l)*exp(j*( kx_vc(k)*x1+ky_vc(l)*y-kz_vc(k,l)*z1 ));
           Hz_xz1=Hz_xz1+HT1z_cof(k,l)*exp(j*( kx_vc(k)*x1+ky_vc(l)*y-kz_vc(k,l)*z1 ));
           end;
        end;
...
[z2 x2]=meshgrid(zz(zz2ind(1):zz2ind(2)),xx); % region 2
    for k=1:NBx
         for l=1:NBy
           ...
           Ey_xz2=Ey_xz2+ET2y_cof(k,l)*exp(j*kz_vc(k,l)*(z2-ac_thick(Nlay))).*exp(j*( kx_vc(k)*x2+ky_vc(l)*y ));   
           Ex_xz2=Ex_xz2+ET2x_cof(k,l)*exp(j*kz_vc(k,l)*(z2-ac_thick(Nlay))).*exp(j*( kx_vc(k)*x2+ky_vc(l)*y ));
           Ez_xz2=Ez_xz2+ET2z_cof(k,l)*exp(j*kz_vc(k,l)*(z2-ac_thick(Nlay))).*exp(j*( kx_vc(k)*x2+ky_vc(l)*y ));
           Hy_xz2=Hy_xz2+HT2y_cof(k,l)*exp(j*kz_vc(k,l)*(z2-ac_thick(Nlay))).*exp(j*( kx_vc(k)*x2+ky_vc(l)*y ));   
           Hx_xz2=Hx_xz2+HT2x_cof(k,l)*exp(j*kz_vc(k,l)*(z2-ac_thick(Nlay))).*exp(j*( kx_vc(k)*x2+ky_vc(l)*y ));
           Hz_xz2=Hz_xz2+HT2z_cof(k,l)*exp(j*kz_vc(k,l)*(z2-ac_thick(Nlay))).*exp(j*( kx_vc(k)*x2+ky_vc(l)*y ));
