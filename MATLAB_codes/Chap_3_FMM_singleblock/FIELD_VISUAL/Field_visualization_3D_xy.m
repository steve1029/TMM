...
figure(1); subplot(3,2,1); imagesc(abs((Ex_xy)));
           subplot(3,2,2); imagesc(abs((Ey_xy)));
           subplot(3,2,3); imagesc(abs((Ez_xy)));
           subplot(3,2,4); imagesc(abs((Hx_xy)));   
           subplot(3,2,5); imagesc(abs((Hy_xy)));
           subplot(3,2,6); imagesc(abs((Hz_xy)));
