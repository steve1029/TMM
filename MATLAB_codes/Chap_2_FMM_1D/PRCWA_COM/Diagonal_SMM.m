...
for laynt=1:Nlay
         ...
         % diagonal anisotropic material
        str_tensor=struct('eps_xx',eps_xx(1,laynt), 'eps_yy',eps_yy(1,laynt),'eps_zz',eps_zz(1,laynt), ...
                    'aps_xx',aps_xx(1,laynt),'aps_yy',aps_yy(1,laynt), 'aps_zz',aps_zz(1,laynt), ...
                    'mu_xx',  mu_xx(1,laynt),'mu_yy',  mu_yy(1,laynt),'mu_zz',  mu_zz(1,laynt), ...
                    'bu_xx',  bu_xx(1,laynt),'bu_yy',  bu_yy(1,laynt),'bu_zz',  bu_zz(1,laynt));
