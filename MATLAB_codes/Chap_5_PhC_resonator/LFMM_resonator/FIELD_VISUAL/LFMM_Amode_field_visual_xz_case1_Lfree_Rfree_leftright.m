...
figure(11);
subplot(3,2,1); imagesc(zz*SNlay/a,xx/a,real([Ex_xz1 AcaGEx_xz Ex_xz2])); title('Ex-xz'); colorbar;
subplot(3,2,2); imagesc(zz*SNlay/a,xx/a,real([Ey_xz1 AcaGEy_xz Ey_xz2])); title('Ey-xz'); colorbar;
subplot(3,2,3); imagesc(zz*SNlay/a,xx/a,real([Ez_xz1 AcaGEz_xz Ez_xz2])); title('Ez-xz'); colorbar;
subplot(3,2,4); imagesc(zz*SNlay/a,xx/a,real([Hx_xz1 AcaGHx_xz Hx_xz2])); title('Hx-xz'); colorbar;
subplot(3,2,5); imagesc(zz*SNlay/a,xx/a,real([Hy_xz1 AcaGHy_xz Hy_xz2])); title('Hy-xz'); colorbar;
subplot(3,2,6); imagesc(zz*SNlay/a,xx/a,real([Hz_xz1 AcaGHz_xz Hz_xz2])); title('Hz-xz'); colorbar;
return;
%%
