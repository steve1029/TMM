...
[z4 x4]=meshgrid(zz,xx4); % region 4
    for k=1:NBx
       ...
       Ey_xz4=Ey_xz4+Uy*exp(j*( kx0*z3+ky0*y-kz0*x3));
       Ex_xz4=Ex_xz4+Ux*exp(j*( kx0*z3+ky0*y-kz0*x3));
       Ez_xz4=Ez_xz4+Uz*exp(j*( kx0*z3+ky0*y-kz0*x3));
       Hy_xz4=Hy_xz4+Vy*exp(j*( kx0*z3+ky0*y-kz0*x3));
       Hx_xz4=Hx_xz4+Vx*exp(j*( kx0*z3+ky0*y-kz0*x3));
       Hz_xz4=Hz_xz4+Vz*exp(j*( kx0*z3+ky0*y-kz0*x3));
