...
yy=0;%yy=3*(-Ty/2:Ty*0.002:Ty/2);

z_repetition=20;
zz=linspace(0,Tz*z_repetition,NN*z_repetition);;
...
figure(60);set(gca,'fontsize',16);set(gca,'fontname','times new roman');
imagesc(zz/a,xx/a,sqrt(abs(repmat(Gr_str,[1 10]))));set(gca,'ydir','normal');set(gca,'fontname','times new roman');
xlabel('z (in unit of a)');set(gca,'fontname','times new roman');
ylabel('x (in unit of a)');set(gca,'fontname','times new roman');
axis equal;axis([zz(1)/a zz(end)/a xx(1)/a xx(end)/a]);
colorbar;caxis([0 4]);set(gca,'fontsize',16);set(gca,'fontname','times new roman');
