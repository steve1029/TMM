...
% figure(2); imagesc(real([Ey_xz1 AcaGEy_xz Ey_xz2])); title('Ey-xz');
% colorbar;
...
figure(11);
subplot(3,2,1); set(gca,'fontsize',16); set(gca,'fontname','times new roman'); imagesc(zz*SNlay/a,xx/a,real([Ex_xz1 AcaGEx_xz Ex_xz2])); set(gca,'ydir','normal'); set(gca,'fontname','times new roman'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('Ex-xz'); set(gca,'fontname','times new roman'); colorbar;set(gca,'fontsize',16); 
subplot(3,2,2); set(gca,'fontsize',16); set(gca,'fontname','times new roman'); imagesc(zz*SNlay/a,xx/a,real([Ey_xz1 AcaGEy_xz Ey_xz2])); set(gca,'ydir','normal'); set(gca,'fontname','times new roman'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('Ey-xz'); set(gca,'fontname','times new roman'); colorbar;set(gca,'fontsize',16); 
subplot(3,2,3); set(gca,'fontsize',16); set(gca,'fontname','times new roman'); imagesc(zz*SNlay/a,xx/a,real([Ez_xz1 AcaGEz_xz Ez_xz2])); set(gca,'ydir','normal'); set(gca,'fontname','times new roman'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('Ez-xz'); set(gca,'fontname','times new roman'); colorbar;set(gca,'fontsize',16); 
subplot(3,2,4); set(gca,'fontsize',16); set(gca,'fontname','times new roman'); imagesc(zz*SNlay/a,xx/a,real([Hx_xz1 AcaGHx_xz Hx_xz2])); set(gca,'ydir','normal'); set(gca,'fontname','times new roman'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('Hx-xz'); set(gca,'fontname','times new roman'); colorbar;set(gca,'fontsize',16); 
subplot(3,2,5); set(gca,'fontsize',16); set(gca,'fontname','times new roman'); imagesc(zz*SNlay/a,xx/a,real([Hy_xz1 AcaGHy_xz Hy_xz2])); set(gca,'ydir','normal'); set(gca,'fontname','times new roman'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('Hy-xz'); set(gca,'fontname','times new roman'); colorbar;set(gca,'fontsize',16); 
subplot(3,2,6); set(gca,'fontsize',16); set(gca,'fontname','times new roman'); imagesc(zz*SNlay/a,xx/a,real([Hz_xz1 AcaGHz_xz Hz_xz2])); set(gca,'ydir','normal'); set(gca,'fontname','times new roman'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('Hz-xz'); set(gca,'fontname','times new roman'); colorbar;set(gca,'fontsize',16); 
return;
%%
for kk=0:0.2:10*2*pi
figure(7); imagesc((real([Hy_xz1 AcaGHy_xz Hy_xz2])));  caxis([-3 3]);
end;
