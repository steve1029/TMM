...
zz_total = a*linspace(0,SNlay_wg1+SNlay_resonator*7+SNlay_wg3,size(AcaGEx_xz_total,2));
xx_total =   linspace(-aTx,aTx,size(AcaGEx_xz_total,1));


% figure(41);
% subplot(3,2,1); set(gca,'fontsize',16); imagesc(zz_total/a,xx_total/a,(real(AcaGEx_xz_total))); set(gca,'ydir','normal'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); axis equal; axis([zz_total(1)/a zz_total(end)/a xx_total(1)/a xx_total(end)/a]); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('aPG-Ex-xz'); colorbar; set(gca,'fontsize',16); 
% subplot(3,2,2); set(gca,'fontsize',16); imagesc(zz_total/a,xx_total/a,(real(AcaGEy_xz_total))); set(gca,'ydir','normal'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); axis equal; axis([zz_total(1)/a zz_total(end)/a xx_total(1)/a xx_total(end)/a]); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('aPG-Ey-xz'); colorbar; set(gca,'fontsize',16); 
% subplot(3,2,3); set(gca,'fontsize',16); imagesc(zz_total/a,xx_total/a,(real(AcaGEz_xz_total))); set(gca,'ydir','normal'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); axis equal; axis([zz_total(1)/a zz_total(end)/a xx_total(1)/a xx_total(end)/a]); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('aPG-Ez-xz'); colorbar; set(gca,'fontsize',16); 
% subplot(3,2,4); set(gca,'fontsize',16); imagesc(zz_total/a,xx_total/a,(real(AcaGHx_xz_total))); set(gca,'ydir','normal'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); axis equal; axis([zz_total(1)/a zz_total(end)/a xx_total(1)/a xx_total(end)/a]); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('aPG-Hx-xz'); colorbar; set(gca,'fontsize',16); 
% subplot(3,2,5); set(gca,'fontsize',16); imagesc(zz_total/a,xx_total/a,(real(AcaGHy_xz_total))); set(gca,'ydir','normal'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); axis equal; axis([zz_total(1)/a zz_total(end)/a xx_total(1)/a xx_total(end)/a]); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('aPG-Hy-xz'); colorbar; set(gca,'fontsize',16); 
% subplot(3,2,6); set(gca,'fontsize',16); imagesc(zz_total/a,xx_total/a,(real(AcaGHz_xz_total))); set(gca,'ydir','normal'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); axis equal; axis([zz_total(1)/a zz_total(end)/a xx_total(1)/a xx_total(end)/a]); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('aPG-Hz-xz'); colorbar; set(gca,'fontsize',16); 
%%
figure(42);
subplot(1,3,1); set(gca,'fontsize',16); set(gca,'fontname','times new roman'); imagesc(zz_total/a,xx_total/a,(real(AcaGEx_xz_total))); set(gca,'ydir','normal'); set(gca,'fontname','times new roman'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)');  axis([zz_total(1)/a zz_total(end)/a xx_total(1)/a xx_total(end)/a]); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('aPG-Ex-xz'); colorbar; set(gca,'fontsize',16); 
subplot(1,3,2); set(gca,'fontsize',16); set(gca,'fontname','times new roman'); imagesc(zz_total/a,xx_total/a,(real(AcaGEz_xz_total))); set(gca,'ydir','normal'); set(gca,'fontname','times new roman'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)');  axis([zz_total(1)/a zz_total(end)/a xx_total(1)/a xx_total(end)/a]); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('aPG-Ez-xz'); colorbar; set(gca,'fontsize',16); 
subplot(1,3,3); set(gca,'fontsize',16); set(gca,'fontname','times new roman'); imagesc(zz_total/a,xx_total/a,(real(AcaGHy_xz_total))); set(gca,'ydir','normal'); set(gca,'fontname','times new roman'); xlabel('z (in unit of a)'); ylabel('x (in unit of a)');  axis([zz_total(1)/a zz_total(end)/a xx_total(1)/a xx_total(end)/a]); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('aPG-Hy-xz'); colorbar; set(gca,'fontsize',16); 
...
while 1;
    ...
    figure(42);
%     subplot(3,2,1); 
%     imagesc((real(AcaGEx_xz_total*exp(-j*qq)))); title('aPG-Ex-xz'); colorbar;
%     subplot(3,2,2); imagesc((real(AcaGEy_xz_total*exp(-j*qq)))); title('aPG-Ey-xz'); colorbar;
%     subplot(3,2,3);
% imagesc((real(AcaGEz_xz_total*exp(-j*qq)))); title('aPG-Ez-xz'); colorbar;
%     subplot(3,2,4); imagesc((real(AcaGHx_xz_total*exp(-j*qq)))); title('aPG-Hx-xz'); colorbar;
%     subplot(3,2,5); 
imagesc(zz_total,xx_total,(1/max(max(abs(AcaGHy_xz_total)))*real(AcaGHy_xz_total*exp(-j*qq)))); set(gca,'ydir','normal');axis equal; axis([zz_total(1) zz_total(end) xx_total(1) xx_total(end)]); xlabel('z (in unit of a)'); ylabel('x (in unit of a)'); title('aPG-Hy-xz'); colorbar;caxis([-1 1]);
%     subplot(3,2,6); imagesc((real(AcaGHz_xz_total*exp(-j*qq))));
%     title('aPG-Hz-xz'); colorbar;
    pause(0.1);
end    
